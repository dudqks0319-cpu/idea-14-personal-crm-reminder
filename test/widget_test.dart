...
import 'package:app_14_personal_crm_reminder/app.dart';
import 'package:app_14_personal_crm_reminder/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('개인 인맥 CRM 리마인더'), findsWidgets);
